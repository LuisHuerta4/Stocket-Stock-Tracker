// To run inngest dev server: npx inngest-cli@latest dev
...
export const sendSignUpEmail = inngest.createFunction(
    ...
    async ({ event, step }) => {
        ...
        await step.run('send-welcome-email', async () => {
            ...
            const introText = (part && 'text' in part ? part.text : null) || 'Thanks for joining Stocket. You now have the tools to track markets and make smarter moves'
...
export const sendDailyNewsSummary = inngest.createFunction(
    ...
    [{ event: 'app/send.daily.news' }, { cron: '0 12 * * *' }], // Run every day at 12 pm UTC
    async ({ step }) => {
        // 1. Get all users
        ...
        // 2. For each user, get watchlist symbols and fetch news
